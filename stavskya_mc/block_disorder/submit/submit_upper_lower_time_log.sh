...
#SBATCH --job-name=ul_tlog         # Assign a short name to your job
...
# Submit from this directory:  cd stavskya_mc/block_disorder/submit && sbatch submit_upper_lower_time_log.sh
...
GEN=../generators/get_upper_lower_binary_time_log.jl
if [ ! -f "$GEN" ]; then
