...
#SBATCH --job-name=ul_tlog_fss         # Assign a short name to your job
...
# Submit from this directory:  cd stavskya_mc/block_disorder/submit && sbatch submit_upper_lower_time_log_fss.sh
...
GEN=../generators/get_upper_lower_binary_time_log_fss.jl
if [ ! -f "$GEN" ]; then
