...
#SBATCH --job-name=sp_tlog         # Assign a short name to your job
...
# Submit from this directory:  cd stavskya_mc/block_disorder/submit && sbatch submit_slidding_p_time_log.sh
...
GEN=../generators/get_slidding_p_time_log.jl
if [ ! -f "$GEN" ]; then
