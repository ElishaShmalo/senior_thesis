...
#SBATCH --job-name=sp_ep_block         # Assign a short name to your job
...
# Submit from this directory:  cd stavskya_mc/block_disorder/submit && sbatch submit_slidding_p_rho_per_ep_block.sh
...
GEN=../generators/get_slidding_p_rho_per_ep_block.jl
if [ ! -f "$GEN" ]; then
