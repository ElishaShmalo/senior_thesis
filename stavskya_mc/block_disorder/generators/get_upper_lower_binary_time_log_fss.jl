...
#
# Cluster:          cd stavskya_mc/block_disorder/submit && sbatch submit_upper_lower_time_log_fss.sh
# Local smoke test: STAV_LOCAL_TEST=1 julia stavskya_mc/block_disorder/generators/get_upper_lower_binary_time_log_fss.jl
