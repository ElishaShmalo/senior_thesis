...
#
# 2026-09 successor of stavskya_mc/get_time_random_slidding_p_time_data.jl (the version
# read by analyze_random_slidding_p_rho_per_time_z2.ipynb).
...
#
# Cluster:          cd stavskya_mc/block_disorder/submit && sbatch submit_slidding_p_time_log_fss.sh
# Local smoke test: STAV_LOCAL_TEST=1 julia stavskya_mc/block_disorder/generators/get_slidding_p_time_log_fss.jl
...
@everywhere begin
    ...
    time_prefact      = 4500.0           # T_f = round(Int, L * time_prefact); see review 4.2.3 before choosing
